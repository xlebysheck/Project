$(function() {
	$(".g-form").submit(function (event) {
		...
		let appLink = "https://script.google.com/macros/s/AKfycbyOQZeePh42xkmOWPJo7j0G-Rg4_Zj_EOGBz-1_JQPqsCpgLknYzM4tSjTYRKZKhtyA/exec";

		// Сообщение при успешной отправке данных
		let successRespond = 'Отчет успешно отправлен';

		// Сообщение при ошибке в отправке данных
		let errorRespond = 'Не удалось отправить сообщение. Cвяжитесь с администратором';
